...
const navigation = [
  ...
  { label: 'Runs', path: '/runs', icon: TestTubes },
      ...
      <div className="main-column">
        <header className="topbar">
          ...
          <form className="search-box" onSubmit={event => {
            ...
            <input value={search} onChange={event => setSearch(event.target.value)} aria-label="Search runs" placeholder="Search runs..." />
